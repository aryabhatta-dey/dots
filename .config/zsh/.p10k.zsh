# Generated by Powerlevel10k configuration wizard on 2020-09-11 at 23:45 IST.
...
() {
  ...
  #################[ ranger: ranger shell (https://github.com/ranger/ranger) ]##################
  # Ranger shell color.
  typeset -g POWERLEVEL9K_RANGER_FOREGROUND=009
  # Custom icon9
  ...
  typeset -g POWERLEVEL9K_VIM_SHELL_FOREGROUND=003
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=252
